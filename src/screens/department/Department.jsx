...
import { department } from '../redux/api/dummyJson';
...
const Department = () => {
    ...
    const viewList = (type) =>{
        navigate("/add-department", {state:{type:type}});
    }
    ...
    return (
        <div className="dashRightView home_section trans">
            <div className='d-flex ac-jb top-search-bar'>
                <h4 className='f3 fs-sm-10 fs-md-16 fs-lg-18 fs-xl-20 fs-xxl-22 mb-0 ps-4 white'>Department</h4>
                <div className='d-flex ac-jc '>
                    ...
                    <button className='add-bar-btn white ms-3' onClick={()=>viewList("add")}>
                        <p className='f1 fs-sm-10 fs-md-10 fs-lg-12 fs-xl-14 fs-xxl-16 mb-0'> + Add Department</p>
                    </button>
                </div>
            </div>
