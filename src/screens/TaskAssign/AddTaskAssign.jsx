    ...
    return (
        <div className="dashRightView home_section trans">
            <div className='ms-5 d-flex '>
                ...
                <h2 className='f3 fs-sm-10 fs-md-16 fs-lg-18 fs-xl-20 fs-xxl-22 ms-2'>{type == "view" ? "View" : type == "edit" ? "Edit" : type == "add" ? "Add"  : ""} Kitchen Task Assign</h2>
            </div>
            <div className='w-90 m-auto'>
                ...
                <div className='mt-4 d-flex justify-content-end w-90 pe-2'>
                    <button onClick={()=>navigate("/task-assign")} className='add-btn mt-2'>
                        Add
                    </button>
                </div>
