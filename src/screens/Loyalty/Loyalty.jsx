...
const Loyalty = () => {
    ...
    const columns = React.useMemo(
        () => [
            ...
            {
                Header: "Minimum Points Required for Redemption",
            ...
            {
                Header: "Discounts and Offers - Loyalty",
                accessor: "town",
                Cell: ({ value, row }) => {
                    return <p>{value}</p>;
                },
        ...
        <div className="dashRightView home_section trans">
            <div>
                <div className='d-flex ac-jb top-search-bar'>
                    <h4 className='f3 fs-sm-10 fs-md-16 fs-lg-18 fs-xl-20 fs-xxl-22 mb-0 ps-4 white'>Loyalty</h4>
                    <div className='d-flex ac-jc '>
                        <button className='add-bar-btn white ms-3' onClick={() => { setPopup(!popup); (setType("add")) }}>
                            <p className='f1 fs-sm-10 fs-md-10 fs-lg-12 fs-xl-14 fs-xxl-16 mb-0'> + Add Loyalty</p>
                        </button>
                    </div>
                </div>
                {popup && (
                    <div className='pop-up'>
                        <div className='popup-des black'>
                            <div className='d-flex ac-jb'>
                                <h4 className='f3 fs-sm-10 fs-md-16 fs-lg-18 fs-xl-20 fs-xxl-22 mb-0 '>{type == "view" ? "View" : type == "edit" ? "Edit" : type == "add" ? "Add" : ""} Loyalty</h4>
                            ...
                            <div className='d-flex gap-3 mt-5'>
                                ...
                                <div className='col-md-6'>
                                    <h2 className='f3 fs-sm-10 fs-md-12 fs-lg-14 fs-xl-16 fs-xxl-18'>Points Per GBP</h2>
                            ...
                            <div className='d-flex gap-3 mt-5 '>
                                <div className='col-md-6'>
                                    <h2 className='f3 fs-sm-10 fs-md-12 fs-lg-14 fs-xl-16 fs-xxl-18'>Discounts and Offers - Loyalty</h2>
                                    <input className='input-fld w-90' type='text' />
                                </div>
                                <div className='col-md-6'>
                                    <h2 className='f3 fs-sm-10 fs-md-12 fs-lg-14 fs-xl-16 fs-xxl-18'>Minimum Points Required for Redemption</h2>
                                    <button onClick={handleChange}
                                        className={`border-0 toggle-btn text-left ${isToggled ? "on" : "off"}`}>
                                        {isToggled ?
                                            <div><img className='w-50' src={toggleOn} /></div> :
